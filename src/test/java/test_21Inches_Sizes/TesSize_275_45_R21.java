...
public class TesSize_275_45_R21 {
	...
	@Test
public void UsershoudbeableToclickon_size_275_45_R21 () throws InterruptedException {

	
	Inches_21 size45R21 = PageFactory.initElements(driver,Inches_21.class );
	size45R21.clickon_size_275_45_R21();
	driver.close();
	}
